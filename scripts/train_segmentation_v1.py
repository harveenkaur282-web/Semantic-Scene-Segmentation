...
def main():
    ...
    data_dir = os.path.join(script_dir, 'dataset', 'Offroad_Segmentation_Training_Dataset', 'train')
    val_dir = os.path.join(script_dir, 'dataset', 'Offroad_Segmentation_Training_Dataset', 'val')
